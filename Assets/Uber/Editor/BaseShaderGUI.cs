...
public class BaseShaderGUI : ShaderGUI
{
    ...
    protected static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode, bool isResetRenderQueue)
    {
        switch (blendMode)
        {
            case BlendMode.Opaque:
                ...
                if (isResetRenderQueue) material.renderQueue = (int) UnityEngine.Rendering.RenderQueue.Geometry;
                break;
