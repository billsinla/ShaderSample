#ifndef BILL_POST_PROCESS
#define BILL_POST_PROCESS
...
// 内部描边
float4 DrawInnerOutline(float4 rawCol, sampler2D tex, float2 uv, float4 outlineColor, float width, float alpha,
                        float glow)
{
