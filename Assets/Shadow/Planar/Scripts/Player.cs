...
public class Player : MonoBehaviour
{
    ...
    public Vector4 m_ProjectValue = new Vector4(0.0f, 1.0f, 0.0f, 0.4f);

    public float ShadowFalloff = 1.5f;
    ...
    private void UpdateShader()
    {
        ...
        foreach (var mat in mMatList)
        {
            ...
            mat.SetVector("_ShadowPlane", m_ProjectValue);
            mat.SetVector("_ShadowFadeParams", new Vector4(0.0f, 1.5f, 0.7f, 0.0f));
            mat.SetFloat("_ShadowFalloff", ShadowFalloff);
        }
    }
